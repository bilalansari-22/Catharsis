...
• Backend / Database: Supabase (Postgres, Auth, Row-Level Security, Edge Functions)
• AI: Google Gemini
• Charts: Recharts

Notes

Originally built in Bolt.new. Recovered and migrated to GitHub for permanent version control.
